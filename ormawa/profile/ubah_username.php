...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Cek apakah username lama cocok
    ...
    if ($result->num_rows > 0) {
        ...
        $duplikat = $cek_duplikat->get_result();
...
<head>
    ...
    <title>Ubah Username Ormawa</title>
...
<div class="profile-container">
    <div class="profile-sidebar">
        ...
        <br><br>
        <a href="profile_ormawa.php"><button class="btn btn-outline-dark">Kembali</button></a>
    </div>
