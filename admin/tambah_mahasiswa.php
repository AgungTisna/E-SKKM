...
<div class="container mt-3 d-flex justify-content-between">
    <a href="detail_mahasiswa.php"><button class="btn-custom">Kembali</button></a>
    <h3 class="text-center flex-grow-1">Tambah Mahasiswa</h3>
</div>
...
<div class="container container-form">
    <form action="proses_tambah_mahasiswa.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="prodi" placeholder="Masukkan Program Studi" required>
        </div>
        <div class="form-group">
