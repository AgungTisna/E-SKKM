...
<head>
    ...
    <title>Tambah Kemahasiswaan</title>
    <!-- Tambahkan Bootstrap -->
...
<div class="container mt-3 d-flex justify-content-between">
    ...
    <h3 class="text-center flex-grow-1">Tambah Kemahasiswaan</h3>
</div>

<!-- Form Tambah Kemahasiswaan -->
<div class="container container-form">
    <form action="proses_tambah_kemahasiswaan.php" method="POST">
        <div class="form-group">
            <label>Nama Kemahasiswaan</label>
            <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama Kemahasiswaan" required>
        </div>
        <div class="form-group">
            <label>NIP</label>
