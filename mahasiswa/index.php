...
// Tambahkan dari berkas_kemahasiswaan
$query_kemahasiswaan = "
    SELECT kategori_kegiatan, nama_kegiatan, partisipasi, tingkat, poin_skkm, tanggal_kegiatan
...
while ($row = $result_kemahasiswaan->fetch_assoc()) {
    ...
    // Tambahkan poin langsung karena diasumsikan divalidasi Kemahasiswaan
    $data_poin[$kategori]['poin'] += $row['poin_skkm'];
    $data_poin[$kategori]['detail'][] = $row;
}
...
// Tambah data dari berkas_bem jika memiliki nomor sertifikat
$query_bem = "
    SELECT kategori_kegiatan, nama_kegiatan, partisipasi, tingkat, poin_skkm, tanggal_kegiatan, nomor_sertifikat_internal
    FROM berkas_bem
    WHERE nim = ?
