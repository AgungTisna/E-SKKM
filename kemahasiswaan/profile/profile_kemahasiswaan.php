...
<head>
    ...
    <title>Profil Kemahasiswaan</title>
...
<div class="profile-container">
    ...
    <div class="profile-content">
        <div class="row">
            <div class="col-md-6">
                <p class="profile-info"><strong>Nama</strong><br><?= htmlspecialchars($user['nama']) ?></p>
                <p class="profile-info"><strong>Email</strong><br><?= htmlspecialchars($user['email']) ?></p>
                <p class="profile-info"><strong>NIP</strong><br><?= htmlspecialchars($user['nip'] ?? '-') ?></p>
                <p class="profile-info"><strong>Jabatan</strong><br><?= htmlspecialchars($user['jabatan'] ?? '-') ?></p>
            </div>
            <div class="col-md-6">
        ...
        <a href="edit_profile_kemahasiswaan.php"><button class="btn-custom">Ubah Profil</button></a>
