...
<head>
    <meta charset="UTF-8">
    <title>Upload Berkas Eksternal</title>
...
<div class="container mt-5">
    <h3>Upload Berkas Eksternal (Excel)</h3>
    <form action="confirm_input_berkas_eksternal.php" method="post" enctype="multipart/form-data">
        <div class="mb-3">
