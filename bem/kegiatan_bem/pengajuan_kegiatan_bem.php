...
<head>
    <meta charset="UTF-8">
    <title>Upload Kegiatan Mahasiswa oleh BEM</title>
...
<div class="navbar">
    ...
    <div class="profile-container" onclick="toggleDropdown()">
        ...
        <div id="profileDropdown" class="dropdown">
            ...
            <a href="/e-skkm/kemahasiswaan/profile.php">Profile</a>
            <a href="/e-skkm/logout.php">Logout</a>
        </div>
    </div>
</div>
<div class="container mt-5">
    <h3 class="mb-4">⬆️ Upload File Excel Kegiatan Mahasiswa</h3>
    <a href="detail_kegiatan_bem.php" class="btn btn-secondary mb-3">← Kembali ke Dashboard</a>
